...
class ParkingLot {
    ...
    public boolean parkCar(Car car) {
        boolean checkLicenseplateIsValid = sports.stream()
                .filter(parkingSport -> parkingSport.getCar()!=null)
                .anyMatch(parkingSport -> parkingSport.getCar().getLicenseplate().equals(car.getLicenseplate()));

        if(checkLicenseplateIsValid){
            System.out.println("Your License plate number must be unique....");
            return false;
        }
